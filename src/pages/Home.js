    ...
    return (
        ...
        <main className="landingPage">
            <div className="welcome-text">
                ...
                <h2 className="genre-text">Pick your favorite music or see who is online.</h2>
            </div>
            <div className="landingPage__buttonContainer">
                ...
                <button className="landingPage__button">
                    <Link style={{ textDecoration: 'none' }} className="landingPage__buttonText"   to="/study-live"> Study Live</Link>
                </button>
            </div>
        </main>
    );
